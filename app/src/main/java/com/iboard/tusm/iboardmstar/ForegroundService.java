...
public class ForegroundService extends Service {
    ...
    public void onCreate() {
        ...
        builder.setTicker("鲲鹏遥控已启动");
        builder.setContentTitle("鲲鹏遥控服务");
        builder.setContentText("鲲鹏遥控服务运行中");
        Notification notification = builder.build();

        startForegroundCompat(NOTIFICATION_ID, notification);

        UDPServer udpServer = new UDPServer(getApplicationContext());
        new Thread(udpServer).start();
        ImgicServer imgicServer = new ImgicServer(getApplicationContext());
        imgicServer.StartThread();
    }
